...
<header class="row">
	...
	<div class="slogan span6">
		...
		<script>
			dw_fixed_style=0; dw_box_float='right'; dw_box_margin='5';
			dw_clean_title='1'; dw_subscr=0;
		</script>
		<!-- // uncomment to enable verse of the day
		<script src='http://feed.dagelijkswoord.nl/js?&t=t&v=0'></script>
		-->
		<script>
			$(document).ready(function() {

				// Uncomment the two rows below to enable "verse of the day"
  				//jQuery('.dagelijkswoordtitel').css('font-weight','bold');
  				//jQuery('.dagelijkswoordtekst').insertBefore('.dagelijkswoordtitel');
